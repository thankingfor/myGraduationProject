...
public class MysqlGenerator{
    ...
    public static void main(String[] args){
        String path1="E:\\Study\\IDEA\\space\\xuanke\\xk-service\\xkservice01\\src\\main\\java";
        String path2="D:\\java\\IdeaSpace\\xuanke\\xk-service\\xkservice01\\src\\main\\java";
        myGenerator(path1,"perclass");
    }
    ...
    private static void myGenerator(String path,String table){
        ...
        dsc.setUrl("jdbc:mysql://47.95.196.58:3306/xuanke?useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("xuanke");
        dsc.setPassword("xuanke");
