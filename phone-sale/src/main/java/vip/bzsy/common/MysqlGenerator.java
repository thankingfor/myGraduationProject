...
public class MysqlGenerator {
    ...
    public static void main(String[] args){
        String path1="E:\\Study\\IDEA\\space\\phone-sale\\src\\main\\java";
        //myGenerator(path1,"x_evaluate");
    }
    ...
    private static void myGenerator(String path,String table){
        ...
        dsc.setUrl("jdbc:mysql://47.95.196.58:3306/phonesale?useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("phonesale");
        dsc.setPassword("phonesale");
