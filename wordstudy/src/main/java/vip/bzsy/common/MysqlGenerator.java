...
public class MysqlGenerator {
    ...
    public static void main(String[] args){
        String path1="D:\\java\\IdeaSpace\\wordstudy\\src\\main\\java";
    ...
    private static void myGenerator(String path,String table){
        ...
        dsc.setUrl("jdbc:mysql://47.95.196.58:3306/wordstudy?useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("wordstudy");
        dsc.setPassword("wordstudy");
